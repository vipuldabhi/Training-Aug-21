var employees : {Id:number,FirstName:string,LastName:string,Address:{FlatNumber:number,City:string,State:string},Salary:number}[] = 
                [{"Id":0,"FirstName":"Mehul","LastName":"Shah","Address":{"FlatNumber":23,"City":"Ahmedabad","State":"Gujarat"},"Salary":50000},
...
for(var i of employees)
{
    console.log(`ID : ${i.Id}, Name : ${i.FirstName + i.LastName}, Address : FlatNumber is ${i.Address.FlatNumber} 
                City is ${i.Address.City} State is ${i.Address.State}, Total Salary : ${(i.Salary)-((i.Salary)*(0.12))}.`);
}
