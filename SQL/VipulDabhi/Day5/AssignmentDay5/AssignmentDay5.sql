...
SELECT  EmployeeID,DATEDIFF(DD,JoiningDate,Incentive_Date) FROM Employee JOIN Incentives ON EmployeeID = Employee_Ref_Id;

--select first_name, incentive amount from employee and incentives table for those employees who have incentives and incentive amount greater than 3000

SELECT FirstName,Incentive_Amount FROM Employee JOIN Incentives ON EmployeeID = Employee_Ref_Id WHERE Incentive_Amount>3000;
